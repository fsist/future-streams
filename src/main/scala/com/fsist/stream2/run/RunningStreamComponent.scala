...
import com.fsist.stream2.{Connector, Transform, StreamOutput, StreamInput}
...
case class RunningConnector[T](completion: Future[Unit],
                               connector: Connector[T]) extends RunningStreamComponent
